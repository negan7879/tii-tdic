...
if server == "411":
    ...
    # pretrained_dir = "/work/zhangzherui/code/mmpretrain/work_dirs/config_finetune_cifar/weights/vit_tiny.pth"
    # pretrained_dir = "/work/zhangzherui/code/mmpretrain/work_dirs/config_finetune_cifar/weights/vit_b.pth"
    # pretrained_dir = "/work/zhangzherui/code/mmpretrain/work_dirs/config_finetune_cifar/weights/vit_s.pth"
